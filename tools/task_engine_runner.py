...
def _research_full_real_dry_intercept_response(
    *,
    ...
    payload = {
        ...
        "selected_execution_mode": "production-research-full",
        "selected_action_after_normalization": effective_action,
        "selected_handler": "run_research_l1_l5_real",
        "selected_handler_source": "tools.task_engine_executors.run_research_l1_l5_real",
        ...
        "forbidden_handler_checks": {
            "run_research_l1_l5_smoke": False,
            "run_research_l2_5_codex_handoff_smoke": False,
        },
        "real_executor_calls": [],
