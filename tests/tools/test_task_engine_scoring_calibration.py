...
VALID_FINAL_REPORT = "\n".join(
    [
        ...
        "",
        "## 证据强度、争议和缺口",
        "证据强度：strong for bounded current evidence; medium for mechanism transfer; weak for long-horizon extrapolation.",
        "争议点：applicability depends on organizational context, governance, and measurement choices.",
        "证据缺口：direct longitudinal evidence for the exact future scenario remains unavailable.",
        "",
        "## 证据分层",
        "### [证据支持]",
