#!/usr/bin/env python3
"""Smoke and contract tests for the obj_art_005 controlled harness."""
...
def run_tests():
    with tempfile.TemporaryDirectory(prefix="obj-art-005-harness-") as tmp_str:
        tmp=Path(tmp_str)
        ...
        assert payload["term_coverage"]["Brutalist"]["passed"] is True
        assert payload["term_coverage"]["concrete"]["passed"] is True
...
if __name__ == "__main__":
    run_tests()
    print("obj_art_005 controlled harness tests PASS")
