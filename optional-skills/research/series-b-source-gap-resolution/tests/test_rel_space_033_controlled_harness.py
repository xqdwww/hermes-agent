#!/usr/bin/env python3
"""Smoke and contract tests for the rel_space_033 controlled harness."""
...
def run_tests():
    with tempfile.TemporaryDirectory(prefix="rel-space-033-harness-") as tmp_str:
        tmp=Path(tmp_str)
        ...
        assert payload["term_coverage"]["cloister"]["passed"] is True
        assert payload["term_coverage"]["scriptorium"]["passed"] is True
...
if __name__ == "__main__":
    run_tests()
    print("rel_space_033 controlled harness tests PASS")
