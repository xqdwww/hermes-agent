#!/usr/bin/env python3
"""Safe API tests for the rel_space_033 controlled harness."""
...
from rel_space_033_alias_source_guard import check_text
from series_b_generic_controlled_harness import CASE_CONFIGS, RESULT_ENUMS

CASE_ID = "rel_space_033"
HANDOFF = Path("/Users/xqdwww/Documents/Codex/2026-06-25/travel-series-b-rel-space-033-formal-handoff-batch/outputs/rel_space_033_controlled_handoff_manifest.json")
CHUNKS = Path("/Users/xqdwww/Documents/Codex/2026-06-25/travel-series-b-rel-space-033-formal-handoff-batch/outputs/rel_space_033_approved_chunks_handoff.json")
RUNNER = TOOLS_DIR / "run_rel_space_033_single_case_controlled.py"
...
def run_tests():
    ...
    assert check_text("rel_space_033 cloister scriptorium refectory monastery source-backed monastic layout") == []
    with tempfile.TemporaryDirectory(prefix="rel-space-033-contracts-") as tmp_str:
        tmp=Path(tmp_str)
...
if __name__ == "__main__":
    run_tests()
    print("rel_space_033 safe API contracts tests PASS")
